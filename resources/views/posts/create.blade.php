                ...
                <div class="p-6 backdrop-blur-3xl">
                    ...
                    <form method="POST" enctype="multipart/form-data" action="{{ route('posts.store', ['group' => $group]) }}" class="space-y-4">
                        ...
                        <div class="mb-6">
                            ...
                            <textarea name="content" id="content" rows="3" class="block mt-1 mb-4 bg-stone-300 border-stone-600 focus:border-stone-700 focus:ring-stone-700 shadow-md rounded-md w-full" required></textarea>
                        </div>
