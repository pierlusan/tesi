                ...
                <div class="p-6 backdrop-blur-3xl">
                    ...
                    <form method="POST" action="{{ route('single_events.store') }}" class="space-y-4">
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input type="text" name="title" class="block bg-stone-400 border-stone-600 focus:border-stone-700 focus:ring-stone-700 w-full shadow-md" id="title" required></x-text-input>
                        </div>
                        <div class="mb-4">
                        ...
                        <select  name="client" id="client" onchange="console.log(this.selectedOptions)"  class="mt-1 block w-full rounded-md shadow-md bg-stone-400 border-stone-600 focus:border-stone-700 focus:ring-stone-700">
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input type="datetime-local" name="date" class="block bg-stone-400 border-stone-600 focus:border-stone-700 focus:ring-stone-700 w-full" id="date" min="{{ now()->toDateString() . 'T' . now()->format('H:i') }}" required></x-text-input>
                        </div>
