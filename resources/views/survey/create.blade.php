            ...
            <div class="backdrop-blur-3xl overflow-hidden shadow-md sm:rounded-lg">
                <div class="p-6 backdrop-blur-3xl">
                    ...
                    <form action="/survey/create" method="post">
                        ...
                        <select name="user_id" id="user_id" onchange="console.log(this.selectedOptions)"  class="mt-1 block w-full rounded-md shadow-md bg-stone-300 border-stone-600 focus:border-stone-700 focus:ring-stone-700">
                        ...
                        <div class="flex items-center justify-end mt-4">
                            <x-primary-button type="submit">Crea Questionario</x-primary-button>
                        </div>
                    </form>
                </div>
            </div>
